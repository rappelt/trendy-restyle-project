export const pl = {
  ...
  home: {
    ...
    heroSubtitle: 'Wysokiej jakości rozwiązania meblowe dla biur, sal konferencyjnych, gastronomii i innych obiektów. Twój partner w profesjonalnych projektach wyposażenia wnętrz.',
